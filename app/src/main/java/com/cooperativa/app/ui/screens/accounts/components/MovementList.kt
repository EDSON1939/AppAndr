...
import com.cooperativa.app.ui.screens.accounts.DetailMovementItem
...
fun MovementItem(movement: Movement) {
    ...
    Row(
        ...
        Column(horizontalAlignment = Alignment.End) {
            Text(text = "$signo ${"%.2f".format(movement.amount)}", color = colorMonto, fontWeight = FontWeight.Bold)
            Text(text = movement.date, fontSize = 12.sp, color = Color.Gray)
        }
    }
}
